...
export default function Home() {
  return (
    <div className="flex   md:grid md:grid-rows-1 md:grid-cols-5 h-screen overflow-hidden max-h-screen ">
          ...
          <div className="text-center md:text-left space-y-6">
            <AnimatedElement animateOnView>
              <SectionTitle shadow={false} black className="leading-none md:text-8xl">
                DO YOU NEED A <span className="text-color">WEBSITE</span> FOR YOURSELF OR FOR YOUR <span className="text-color">BUSINESS?</span>
              </SectionTitle>
            </AnimatedElement>
            <AnimatedElement
              element="p"
      ...
      <div className="col-span-2 bg-secondary h-full hidden md:inline border-l border-l-secondary/30">
