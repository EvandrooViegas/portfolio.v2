      ...
      <div className="md:col-span-3">
        <Container center={false} full={false}  className="flex flex-col justify-between h-full">
          ...
          <div className="text-center md:text-left">
            ...
            <AnimatedElement element="p" animate={{ opacity: [0, 1], transition: { delay: 0.3 } }} className="md:text-3xl ">
          ...
          <AnimatedElement animate={{ opacity: [0, 1], x: [-100, 0], transition: { delay: 0.7 } }}>

          <Button className="w-full mt-3 flex items-center gap-3 md:w-fit md:mt-0 bg-black" >
