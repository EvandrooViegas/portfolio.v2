...
const stats = [
  {
    name: "HAPPY CLIENTS",
    value: 47,
    description: "CLIENTES THAT APPROVED MY WORK",
  },
  { name: "TRUSTED BY", value: 6, description: "COMPANIES" },
  {
    name: "EXPRIENCE",
    value: 7,
    description: "WITH MORE THAN 7 YEARS OF EXPRIENCE",
  },
  {
    name: "DEVELOPED PROJECTS",
    value: 79,
    description: "MORE THAN 79 DEVELOPED PROJECTS",
  },
];
        ...
        {stats.map((s, idx) => (
          ...
          >
            <div className="flex flex-col gap-2 group text-center p-8 border border-secondary/20 h-full justify-center items-center ">
              ...
              />
              <span className="font-semibold text-4xl text-color">
                {s.name}
              </span>
